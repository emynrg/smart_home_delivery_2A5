...
{
    this->NOMBRE_DE_RECLAMATION=0;
    this->identifiant_reclamation="";
    this->pourcentage_de_reclamation="";
    this->pourcentage_augmentation="";
     this->date_="";
}
historique::historique(int NOMBRE_DE_RECLAMATION,QString identifiant_reclamation, QString pourcentage_de_reclamation,QString pourcentage_augmentation ,QString date_)
{
    this->identifiant_reclamation=identifiant_reclamation;
    this->date_=date_;
    this->NOMBRE_DE_RECLAMATION=NOMBRE_DE_RECLAMATION;
...
bool historique::ajouter(){
    ...
    QSqlQuery query;
    QString ids=QString::number(NOMBRE_DE_RECLAMATION);

    query.prepare("insert into historique (IDENTIFIANT_RECLAMATION,DATE_,NOMBRE_DE_RECLAMATION,POURCENTAGE_DE_RECLAMATION,POURCENTAGE_AUGMENTATION)"
                  "VALUES(:identifiant_reclamation,:date_,:NOMBRE_DE_RECLAMATION,:pourcentage_de_reclamation,:pourcentage_augmentation)");
    query.bindValue(":nombre",NOMBRE_DE_RECLAMATION);
...
QSqlQueryModel * historique::afficher(){
    ...
    query->setHeaderData(2,Qt::Vertical,QObject::tr("NOMBRE_DE_RECLAMATION"));
...
bool historique::modifier(){
    QSqlQuery query1;
    query1.prepare("UPDATE historique set IDENTIFIANT_RECLAMATION=:identifiant_reclamation ,POURCENTAGE_AUGMENTATION=:pourcentage_augmentation,DATE_=:date_,POURCENTAGE_DE_RECLAMATION=:pourcentage_de_reclamation WHERE NOMBRE_DE_RECLAMATION=:NOMBRE_DE_RECLAMATION");
    query1.bindValue(":NOMBRE_DE_RECLAMATION",NOMBRE_DE_RECLAMATION);
...
{QSqlQueryModel * model =new QSqlQueryModel();
    model ->setQuery("select * from historique order by NOMBRE_DE_RECLAMATION");
    ...
    model->setHeaderData(2,Qt::Horizontal,QObject ::tr("NOMBRE_DE_RECLAMATION"));
...

{
    ...
    QSqlQueryModel * model = new QSqlQueryModel();
         model->setQuery("select * from historique where ((identifiant_reclamation || date_|| NOMBRE_DE_RECLAMATION|| pourcentage_augmentation|| pourcentage_de_reclamation) LIKE '%"+aux+"%')");
         model->setHeaderData(0,Qt::Horizontal,QObject ::tr("identfiant_reclamation"));
         model->setHeaderData(1,Qt::Horizontal,QObject ::tr("date_"));
         model->setHeaderData(2,Qt::Horizontal,QObject ::tr("NOMBRE_DE_RECLAMATION"));
         model->setHeaderData(3,Qt::Horizontal,QObject ::tr("pourcentage_augmentation"));
